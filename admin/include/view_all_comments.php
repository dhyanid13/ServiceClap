...
//        
        ...
        echo "<td><a class='btn btn-info fa fa-thumbs-up' href='comments.php?approve=$comment_id'>  Approve</a></td>";
        echo "<td><a class='btn btn-warning a fa fa-thumbs-down' href='comments.php?unapprove=$comment_id'> Unapprove</a></td>";
        echo "<td><a  class='btn btn-danger fa fa-trash-o ' href='comments.php?delete=$comment_id'>  Delete</a></td>";
        echo "</tr>";
